    ...
    <div className='relative flex items-center justify-center'>
      <div className='absolute z-20'>
        <div className='flex flex-col gap-6 w-[98%] mx-auto'>
          <div className='bg-gray-200 py-3 px-5 grid grid-cols-3 gap-5'>
            <h3 className='p-1 lg:py-1 bg-gray-800 text-white text-center'>
              Email
            </h3>
            <input
              type='email'
              className='outline-none lg:w-72 col-span-2'
